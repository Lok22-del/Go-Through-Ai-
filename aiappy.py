...
GOOGLE_API_KEY = "AIzaSyCmUdK8gM4NWaZyvw922Ip0Xmuq0kZhCcs"  # Add your API key
...
# Main app function
def main():
    st.set_page_config(page_title="Go through AI", layout="wide", page_icon="🤖")
    ...
    with st.sidebar:
        ...
        st.sidebar.markdown("""
        - **Scene Understanding:** - Explains what's in the uploaded image.
        - **Text-to-Speech:**- Reads out any text found in the image using OCR.
        - **Object & Obstacle Detection:** - Spots objects or obstacles to help with safe navigation.
        - **Personalized Assistance:** - Provides specific help based on the image, like reading labels or identifying items.  
        """)
        if st.button("🔗 About Developer"):
            st.markdown("""
            **Name:** Thatikonda Lokesh 

            """)
            st.markdown("---")

    # Main page
    st.title('Go Through AI 💻👁️')
    st.write("""
